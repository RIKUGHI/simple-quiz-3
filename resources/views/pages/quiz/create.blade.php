      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="p-4 sm:p-8 bg-white shadow-sm sm:rounded-lg">
            <section>
              ...
              <form method="post" action="{{ route('quizzes.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div>
                    ...
                    <x-text-input id="title" name="title" type="text" value="{{ old('title') }}" class="mt-1 block w-full" />
